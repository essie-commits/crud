    ...
    for (let e = 0; e <btnEditar.length; e++) {
        btnEditar[e].addEventListener("click", (evento1) => {
            ...
            editar.addEventListener("submit", (evento2) => {
                ...
                campeonatos[e] = {
                    nome: edicao.getNome() !== "" ? edicao.getNome() : campeonatos[e].nome, 
                    data: edicao.getData() !== "" ? edicao.getData() : campeonatos[e].data, 
                    modalidade: edicao.getModalidade() !== "0" ? edicao.getModalidade() : campeonatos[e].modalidade
                };
